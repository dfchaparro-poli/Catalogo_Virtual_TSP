        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @role('admin')
                    <x-nav-link href="{{ route('admin.dashboard') }}" :active="request()->routeIs('admin.*')" class="text-decoration-none">
                        {{ __('Admin') }}
                    </x-nav-link>
                    @endrole
                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <!-- Account Management -->
                            <div class="block px-4 py-2 text-xs text-gray-400">
                                {{ __('Gestíon de Cuenta') }}
                            </div>

                            <x-dropdown-link href="{{ route('profile.show') }}" class="text-decoration-none">
                                <i class="bi bi-person-fill"></i> {{ __('Perfil') }}
                            </x-dropdown-link>


                            @role('admin')
                            <x-dropdown-link href="{{ url('admin') }}" class="text-decoration-none">
                                <i class="bi bi-gear-wide-connected"></i> {{ __('Admin') }}
                            </x-dropdown-link>
